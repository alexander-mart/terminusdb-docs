...
> [!IMPORTANT]
> TerminusDB documentation is now served through our [headless content management system TerminusCMS](https://terminusdb.com/docs) meaning this repository is out of date. For up-to-date documentation, visit our [documentation site][terminusdb-docs].
